  ...
  <div class="admin-orders container section-padding fade-in-up">
    <div class="admin-layout">
      ...
      <main class="admin-content">
        ...
        <p class="text-muted">
          Manage your Marrakech warehouse fulfillment and local deliveries.
        </p>

        <div class="orders-list mt-2">
          
          <div v-if="!orders?.length" class="empty-state card">
            No orders found yet.
          </div>
          ...
          >
            <div class="order-header">
              ...
              <div class="order-status-row">
                ...
                <div
                  v-if="order.whatsappClicked"
                  class="whatsapp-badge"
                  title="Customer clicked WhatsApp link"
                >
                  <img
